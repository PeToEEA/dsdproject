...
class BootStrap {
    ...
    public void addTovar(String testProperyName) {
        ...
        if (!tovar) {
            new Tovar(nazov: testProperyName, vyrobca: testProperyName, popis: testProperyName, farba: testProperyName, cena: testProperyName, kod: testProperyName, lastLocalUpdate: new Date()).save(failOnError: true)
        }
    }
